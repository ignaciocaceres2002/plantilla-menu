...
<body>
	...
	<div class="container-fluid background2">
		...
		<div class="row my-3 my-lg-5 d-flex justify-content-center">
			<div class="col-10 col-lg-8"> 
				...
				<!-- slogan: ingresar una frase, slogan o caracteristica del local -->

				<h3 class="slogan"> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do </h3>
			</div>		
		</div>
	...
	<div class="container-fluid background3 ">
				...
				<div class="row">
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3  text-center " style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon1.jpg" class="img-fluid" alt="">
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3   thumbnail text-center " style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon2.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 2</p>
 								</div>
						</a>										
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3   thumbnail text-center " style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon3.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 3</p>
 								</div>
						</a>	
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3   thumbnail text-center" style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon4.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 4</p>
 								</div>
						</a>		
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3  thumbnail text-center " style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon5.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 5</p>
 								</div>
						</a>
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3 thumbnail text-center" style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon6.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 6</p>
 								</div>
						</a>
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3 thumbnail text-center" style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon7.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 7</p>
 								</div>
						</a>
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3 thumbnail text-center" style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon8.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 8</p>
 								</div>
						</a>
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3 thumbnail text-center" style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon9.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 9</p>
 								</div>
						</a>	
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3 thumbnail text-center" style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon10.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 10</p>
 								</div>
						</a>	
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3 thumbnail text-center" style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon11.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 11</p>
 								</div>
						</a>	
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3 thumbnail text-center" style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon12.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 12</p>
 								</div>
						</a>	
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3 thumbnail text-center" style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon13.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 								<p>Subcategoría 13</p>
 							</div>
						</a>
					...
					<div class="col-12 col-md-6  col-lg-4 col-xl-3 thumbnail text-center" style="padding: 0; margin: 0; border: 0;">
						<a href="plantilla-categorias.php">
							<img src="img/icon/icon14.jpg" class="img-fluid" alt="">
								<div class="titulo-menu"> 
 									<p>Subcategoría 14</p>
 								</div>
						</a>
